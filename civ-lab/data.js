...
const MAIN_NETWORK = {
  ...
  stages: [
    ...
    { id:'STAGE_01', title:'早期文明',     title_en:'Early Civilizations', icon:'🏛', y:340, color:'#c86820',
      time_range:'前3500-前1000',  core_question:'城市、文字、王权如何出现？', core_question_en:'How did cities, writing & kingship arise?',
      status:'active', featured:true, featured_stat:'12 文明 · 27 事件 · 34 人物' },
    { id:'STAGE_02', title:'古典思想与帝国', title_en:'Classical Thought & Empires', icon:'💡', y:520, color:'#b83018',
      time_range:'前1000-公元550',  core_question:'思想、帝国、宗教如何塑造世界？', core_question_en:'How did ideas, empires & religion shape the world?',
      status:'active', featured:true, featured_stat:'22 文明 · 49 事件 · 156 人物' },
    { id:'STAGE_03', title:'中世纪多中心',  title_en:'A Multipolar Medieval World', icon:'🌍', y:700, color:'#8a5a90',
      time_range:'公元500-1500',    core_question:'世界如何通过宗教、贸易、城市连接？', core_question_en:'How did religion, trade & cities connect the world?',
