    ...
    active_civs: [
      {
        ...
        L3_events: ['evt_royal_tombs_ur', 'evt_lagash_umma_war', 'evt_gilgamesh_epic', 'evt_lugalzagesi'],
        L4_people: ['gilgamesh', 'enkidu', 'puabi', 'eannatum', 'lugalzagesi'],
      ...
      },
      {
        ...
        L3_events: ['evt_step_pyramid', 'evt_great_pyramid', 'evt_giza_complex', 'evt_pyramid_texts'],
        L4_people: ['djoser', 'imhotep', 'sneferu', 'khufu', 'khafre'],
...

  {
    ...
    active_civs: [
      ...
      { id: 'akkad', state: '崛起→巅峰→崩溃',
        ...
        L3_events: ['evt_sargon_conquest', 'evt_naramsin_empire', 'evt_enheduanna', 'evt_akkad_collapse'], L4_people: ['sargon', 'enheduanna', 'naramsin'], L5_full: 'CIV_DEEP.akkad' },
      ...
      { id: 'indus', state: '巅峰',
        ...
        L3_events: ['evt_indus_peak', 'evt_indus_trade'], L4_people: [], L5_full: 'CIV_DEEP.indus' },
      { id: 'xia', state: '建立',
        in_period_summary: '中国黄河中游。约前 2070 年大禹治水成功受舜禅让，其子启废禅让、立世袭，开创中国传说中的第一个王朝——夏。',
        L1: '中国进入夏朝——传说中的第一个世袭王朝。',
        L2: '大禹用"疏导"治服黄河洪水 13 年（"三过家门而不入"），因功受禅。其子启打破禅让、确立"父死子继"的世袭制（"家天下"），开启中国近 4000 年的王朝传统。夏朝至今缺直接文字证据，河南二里头遗址被多数中国学者视为夏都。',
        L3_events: ['evt_yu_flood', 'evt_qi_hereditary'],
        L4_people: ['yu_the_great', 'qi_xia', 'taikang', 'houyi'],
        L5_full: 'CIV_DEEP.xia' },
    ],
...

  {
    ...
    active_civs: [
      { id: 'babylon', state: '崛起→巅峰',
        ...
        L3_events: ['evt_hammurabi_code', 'evt_hittite_sack_babylon', 'evt_enuma_elish'], L4_people: ['hammurabi'], L5_full: 'CIV_DEEP.babylon' },
      { id: 'egypt_mid', state: '重新统一→黄金时代',
        in_period_summary: '埃及走出第一中间期：蒙图霍特普二世重新统一(~前2055)，第十二王朝开创古典文化黄金时代——文学、法尤姆水利、努比亚要塞、来世信仰大众化。',
        L1: '埃及中王国：古典文化的黄金时代。',
        L2: '古王国崩溃后约150年分裂，蒙图霍特普二世重新统一埃及。第十二王朝(辛努塞尔特、阿蒙内姆赫特)励精图治：古典埃及语文学《西努赫的故事》、法尤姆绿洲开发与"迷宫"、努比亚要塞体系、奥西里斯来世信仰走向平民。约前1650年喜克索斯人入侵，进入第二中间期。',
        L3_events: ['evt_mk_reunification', 'evt_sinuhe', 'evt_senusret3_nubia', 'evt_faiyum'], L4_people: ['mentuhotep', 'amenemhat1', 'senusret1', 'senusret3', 'amenemhat3'], L5_full: 'CIV_DEEP.egypt_mid' },
      { id: 'indus', state: '衰落',
      ...
      { id: 'minoan', state: '崛起→巅峰→被火山击垮',
        ...
        L3_events: ['evt_knossos_palace', 'evt_thera_eruption', 'evt_minoan_fall'], L4_people: ['minos'], L5_full: 'CIV_DEEP.minoan' },
      { id: 'xia', state: '中兴→灭亡',
        in_period_summary: '夏朝中期"太康失国"被东方有穷氏后羿夺权，禹的后代少康反攻"复国"。末王桀暴虐，约前 1600 年被商汤在鸣条之战击败，夏亡。',
        L1: '夏朝经历"少康中兴"后走向灭亡，被商汤取代。',
        L2: '本期夏朝两件大事：① 太康失国→少康复国（中国史书记载的第一个"王朝中兴"）；② 末王桀失德，约前 1600 年商汤+伊尹起兵，鸣条之战灭夏——"汤武革命"开创了"天命可移"的政治观。',
        L3_events: ['evt_shaokang', 'evt_shang_founding'],
        L4_people: ['jie_xia'],
        L5_full: 'CIV_DEEP.xia' },
      { id: 'shang', state: '崛起',
...

  {
    ...
    active_civs: [
      { id: 'egypt_new', state: '巅峰',
        ...
        L3_events: ['evt_hyksos_expulsion', 'evt_punt_expedition', 'evt_akhenaten_reform', 'evt_kadesh', 'evt_merneptah_stele'],
        L4_people: ['ahmose', 'hatshepsut', 'thutmose3', 'amenhotep3', 'akhenaten', 'nefertiti', 'tutankhamun', 'ramesses2', 'ramesses3'],
      ...
      { id: 'hittite', state: '崛起→巅峰→崩溃',
        ...
        L3_events: ['evt_kadesh', 'evt_telepinu', 'evt_hittite_sack_babylon'], L4_people: ['mursili1', 'suppiluliuma', 'muwatalli', 'hattusili'], L5_full: 'CIV_DEEP.hittite' },
      { id: 'mycenaean', state: '崛起→崩溃',
        ...
        L3_events: ['evt_trojan_war', 'evt_mycenae_goldmask'], L4_people: ['agamemnon'], L5_full: 'CIV_DEEP.mycenaean' },
      { id: 'shang', state: '巅峰→崩溃',
        ...
        L3_events: ['evt_wuding_peak', 'evt_oracle_bones', 'evt_shang_bronze', 'evt_battle_muye'],
        L4_people: ['wuding', 'fuhao', 'fushuo', 'dixin', 'zhou_wu', 'taijia'],
        L5_full: 'CIV_DEEP.shang' },
