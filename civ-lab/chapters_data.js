...

  {
    ...
    active_civs: [
      ...
      },
      {
        ...
        L3_events: ['evt_great_pyramid'],
        L4_people: ['imhotep', 'khufu'],
...

  {
    ...
    active_civs: [
      ...
      { id: 'akkad', state: '崛起→巅峰→崩溃',
        ...
        L3_events: ['evt_sargon_conquest'], L4_people: ['sargon', 'enheduanna'], L5_full: 'CIV_DEEP.akkad' },
...

  {
    ...
    active_civs: [
      { id: 'babylon', state: '崛起→巅峰',
        ...
        L3_events: ['evt_hammurabi_code'], L4_people: ['hammurabi'], L5_full: 'CIV_DEEP.babylon' },
      { id: 'indus', state: '衰落',
      ...
      { id: 'minoan', state: '崛起→巅峰→被火山击垮',
        ...
        L3_events: ['evt_thera_eruption'], L4_people: [], L5_full: null },
      { id: 'shang', state: '崛起',
...

  {
    ...
    active_civs: [
      { id: 'egypt_new', state: '巅峰',
        ...
        L3_events: ['evt_akhenaten_reform', 'evt_kadesh'],
        L4_people: ['hatshepsut', 'thutmose3', 'akhenaten', 'tutankhamun', 'ramesses2'],
      ...
      { id: 'hittite', state: '崛起→巅峰→崩溃',
        ...
        L3_events: [], L4_people: ['suppiluliuma'], L5_full: null },
      ...
      { id: 'collapse', state: '集体崩溃',
        ...
        L3_events: ['evt_bronze_collapse'], L4_people: [], L5_full: null },
    ],
    key_events: [], key_people: [],
