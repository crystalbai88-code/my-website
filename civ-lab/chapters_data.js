    ...
    active_civs: [
      {
        ...
        L4_people: ['gilgamesh', 'enkidu', 'puabi'],
...

  {
    ...
    active_civs: [
      { id: 'sumer', state: '被征服后复兴',
        ...
        L3_events: ['evt_urnammu_law'], L4_people: ['urnammu', 'enheduanna'], L5_full: 'CIV_DEEP.sumer' },
...

  {
    ...
    active_civs: [
      { id: 'egypt_new', state: '巅峰',
        ...
        L4_people: ['hatshepsut', 'thutmose3', 'akhenaten', 'nefertiti', 'tutankhamun', 'ramesses2'],
      ...
      { id: 'collapse', state: '集体崩溃',
        ...
        L3_events: ['evt_bronze_collapse'], L4_people: [], L5_full: 'CIV_DEEP.collapse' },
    ],
    key_events: [], key_people: [],
